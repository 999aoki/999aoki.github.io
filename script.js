...
noButton.addEventListener('click', function() {
  if (noClickCount < 5) {
    ...
    if (noClickCount < 6) {
      noButton.textContent = ["No", "Are you sure?", "I know you want to", "C'mon click yes", "CLICK IT.", "YOU HAVE NO CHOICE >:)"][noClickCount];
    }
  }
});
...
yesButton.addEventListener('click', () => {
  ...
  valentineQuestion.textContent = "YAY!!!"; // Change the question text
